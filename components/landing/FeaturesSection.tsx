    ...
    <section className="py-8 sm:py-12 md:py-16 bg-muted/30 dark:bg-muted/10">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="text-center mb-10 sm:mb-14">
          <span className="inline-block text-primary dark:text-primary/90 font-bold tracking-wider uppercase text-xs sm:text-sm mb-3 px-4 py-1.5 bg-primary/10 dark:bg-primary/20 rounded-full">
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground dark:text-muted-foreground/90 max-w-3xl mx-auto">
            Smart Pokhara bridges the gap between citizens and local government
            with transparency and efficiency.
          </p>
        </div>

        {/* Features Grid - UI/UX Preserved */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          {FEATURE_GROUPS.map((group, idx) => (
            <div
              key={idx}
              className="group relative rounded-3xl bg-card dark:bg-card/80 border border-border dark:border-border/50 p-6 sm:p-8 lg:p-10 shadow-lg hover:shadow-2xl dark:hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden"
            >
              ...
              <div className="relative flex items-center gap-4 mb-8 sm:mb-10">
                ...
                <div>
                  ...
                  <div className="h-1 w-12 sm:w-16 bg-gradient-to-r from-primary to-secondary rounded-full mt-2" />
                </div>
              </div>
              ...
              <div className="absolute -bottom-10 -right-10 w-40 h-40 rounded-full bg-gradient-to-br from-primary/10 to-secondary/10 blur-3xl group-hover:scale-150 transition-transform duration-700" />
            </div>
          ))}
        </div>
        ...
        <div className="text-center mt-10 sm:mt-14">
          <p className="text-sm sm:text-base text-muted-foreground dark:text-muted-foreground/90 mb-4">
            Ready to experience seamless civic engagement?
          </p>
          <button className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-primary dark:bg-primary/90 hover:bg-primary/90 dark:hover:bg-primary text-primary-foreground font-bold rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-105">
