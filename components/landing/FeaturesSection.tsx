...
export const FeaturesSection = () => {
  return (
    <section className="py-12 sm:py-16 md:py-24 bg-muted transition-colors duration-400">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        
        {/* Header */}
        <div className="text-center mb-12 sm:mb-16 animate-fade-in">
          <span className="inline-block text-primary font-heading font-bold tracking-wide uppercase text-xs sm:text-sm mb-4 px-4 py-1.5 bg-accent rounded-full border border-primary">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
          {FEATURE_GROUPS.map((group, idx) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-linear-to-br ${group.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500`}
              />

              <div className="relative flex items-center gap-5 mb-8 sm:mb-10">
                <div
                  className={`h-14 w-14 sm:h-16 sm:w-16 rounded-2xl bg-linear-to-br ${group.gradient} flex items-center justify-center shadow-md`}
                >
                ...
                <div>
                  ...
                  <div className="h-1 w-12 sm:w-16 bg-linear-to-r from-primary to-secondary rounded-full mt-2.5 transition-all duration-500 group-hover:w-full" />
                </div>
              </div>
              ...
              <div className="absolute -bottom-12 -right-12 w-48 h-48 rounded-full bg-linear-to-br from-primary/10 to-secondary/10 blur-3xl group-hover:scale-150 transition-transform duration-700 pointer-events-none" />
            </div>
          ))}
        </div>
        ...
        <div className="text-center mt-12 sm:mt-16 animate-fade-in">
          ...
          <button className="inline-flex items-center gap-2 px-8 py-4 bg-primary hover:bg-primary text-primary-foreground font-heading font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 active:scale-95">
