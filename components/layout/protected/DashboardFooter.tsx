...
export function DashboardFooter() {
  ...
  return (
    <footer className="w-full py-6 mt-auto border-t border-border bg-background backdrop-blur-sm">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted-foreground px-1">
        <div className="flex items-center gap-2">
            <span className="font-semibold text-foreground">Smart Pokhara</span>
        ...
        <div className="flex items-center gap-2 hover:opacity-100 transition-opacity">
            ...
            <span className="font-bold text-foreground">Municipality OS</span>
        </div>
      </div>
    </footer>
  );
