          ...
          <div className="flex items-start justify-between gap-4">
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <Badge
                  variant="outline"
                  className="gap-2 text-xs font-black px-3 py-1 border-2"
                >
          ...
          <ScrollArea className="h-[340px]">
            <AnimatePresence mode="wait">
              {notices.length === 0 ? (
                ...
                >
                  <div className="p-6 bg-muted rounded-2xl mb-5 shadow-sm">
                    <Newspaper
                  ...
                  {notices.map((notice, index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="p-5 hover:bg-muted/60 transition-all duration-300"
                        role="listitem"
                      >
                        <div
                        ...
                        >
                          <div className="flex items-start justify-between mb-3">
                            ...
                            <div className="flex flex-col items-end gap-2.5 ml-5 shrink-0">
                              ...
                              <div className="flex items-center gap-1.5">
                                <Button
                                  variant="ghost"
                                  size="icon"
                                  className="h-8 w-8 hover:bg-warning/10 focus-visible:ring-2 focus-visible:ring-warning transition-all rounded-xl"
                                  onClick={(e) => {
                                    e.stopPropagation();
                                ...
                                <Button
                                  variant="ghost"
                                  size="icon"
                                  className="h-8 w-8 hover:bg-primary/10 focus-visible:ring-2 focus-visible:ring-primary transition-all rounded-xl"
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    handleShare(notice);
                                  }}
