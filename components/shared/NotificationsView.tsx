...
export function NotificationsView({
  ...
  const getNotificationIcon = (type: string) => {
    switch (type) {
      ...
      case "escalation":
        return { icon: "bg-purple-100 text-purple-600 border-purple-200", dot: "bg-purple-500" };
      default:
        ...
        <CardContent className="p-6">
          {loading ? (
            ...
            <div className="text-center py-24 flex flex-col items-center gap-6">
              ...
              <div>
                <p className="text-sm font-black text-foreground uppercase tracking-widest">{emptyStateTitle}</p>
