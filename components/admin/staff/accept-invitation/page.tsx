...
function AcceptInvitationContent() {
  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      // Step 2: Accept invitation (assigns role)
      ...
      alert("Account created successfully! Welcome to the staff portal.");
        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={accepting}
              className="w-full flex items-center justify-center gap-2 rounded-lg bg-blue-600 py-3 px-4 text-sm font-semibold text-white shadow-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
              {accepting ? (
                <>
          ...
          <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-xs text-yellow-800">
              <strong>Note:</strong> By creating an account, you confirm that you have been authorized by 
              Pokhara Metropolitan City to access the staff portal.
            </p>
          </div>
        </div>
