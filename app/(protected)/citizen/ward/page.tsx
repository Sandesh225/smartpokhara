 ...
 * Displays user's ward and all wards in the city
 */
...
export default async function WardPage() {
  ...
  // Fetch user's ward if set in profile
  let userWard = null;
      ...
      {userWard ? (
              ...
              {userWard.population && (
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-blue-900">
                    {userWard.population.toLocaleString()}
                  </p>
                </div>
              )}
              {userWard.area_sq_km && (
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
          ...
          <p className="text-yellow-700">
            Your ward information is not set in your profile. Please update your
            profile to see ward-specific information.
          </p>
        </div>
      )}
