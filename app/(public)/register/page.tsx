    ...
    <div className="min-h-screen w-full lg:grid lg:grid-cols-2 bg-background">
      ...
      <div className="flex flex-col justify-center px-4 py-12 sm:px-6 lg:px-20 xl:px-24 bg-background">
        <div className="mx-auto w-full max-w-sm lg:w-96 space-y-8">
          ...
          {/* Footer */}
          <div className="text-center text-xs text-muted-foreground mt-8 leading-relaxed border-t border-border pt-6">
            <p>
      ...
      <div className="relative hidden lg:block overflow-hidden">
        ...
        <div className="absolute inset-0 h-full w-full bg-muted">
          ...
          />
          {/* Gradient Overlay */}
          <div className="absolute inset-0 bg-gradient-to-br from-primary/80 via-secondary/50 to-transparent dark:from-card/95 dark:via-background/80 dark:to-transparent" />
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 lg:p-16 text-white z-10">
          <div className="max-w-md space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            {/* Status Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-md bg-white/10 border border-white/20 shadow-lg">
            ...
            <div className="flex items-center gap-4 pt-4 flex-wrap">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="h-10 w-10 rounded-full border-2 border-white/30 bg-accent shadow-lg"
                    style={{
        ...
        {/* Decorative Elements */}
        <div className="absolute top-10 right-10 w-32 h-32 rounded-full bg-secondary/20 blur-3xl animate-pulse" />
        <div
          className="absolute bottom-1/3 left-10 w-40 h-40 rounded-full bg-primary/20 blur-3xl animate-pulse"
